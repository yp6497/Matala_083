...
public class MainActivity extends AppCompatActivity implements AdapterView.OnItemSelectedListener, AdapterView.OnItemClickListener {
    ...
    String[][] Medinot = {{"Choose a country in Africa","Congo", "madagascar", "morocco", "nigeria", "Tanzania", "Uganda", "sudan"}, {"Choose a country in America","Argentina", "canada", "Brazil", "colombia", "Mexico", "United States", "Venezuela"},
            {"Choose a country in Asia","China", "India", "Israel", "Japan", "Russia", "Turkey", "Yemen"}, {"Choose a country in Europe","Bulgaria", "France", "Germany", "Hungary", "Italy", "Norway", "Sweden"}};
    ...
    String [][] IaboutCitiesAfrica = {/*1*/{"222 km2","143,435"},{"65 km2","162,521"},{"60 km2 ","870,954"},{"7,428 km2 ","1,271,704"},{"747 km2","1,794,118"}/*2*/,{"85.01 km2","1,275,207"},{"132.94 km2","257,163"},{"42 km2","115,015"},{"20 km2","300,813"},{"16 km2","156,710"},/*3*/
    ...
    String [][] IaboutCitiesAmerica = {/*1*/{"178.69 km2","1,236,089"},{"576 km2","1,391,298"},{"500 km2","346,334"},{"72,066 km2","234,000"},{"125 km2","535,303"},/*2*/{"661,848 km2","4,067,175"},{"649,950 km2","1,278,365 "},{"72,907 km2","747,101"},{"1,076,395 km2","13,448,494 "},{"482,443 km2","35,874"},
    ...
    String [][] IaboutCitiesAsia = {/*1*/{"13,590 km2","5,311,379"},{"16,410.5 km2","21,542,000"},{"9,775 km2","7,599,913"},{"5,533 km2","2,333,896"},{"19,069 km2","2,559,545"},/*2*/{"183 km2 ","647,057"},{"195 km2","709,665"},{"155 km2","603,797"},{"168.4 km2","743,354"},{"203 km2","637,272"},
    ...
    String [][] IaboutCitiesEurope = {/*1*/{"253.644 km2"," 202,694"},{"109.018 km2","88,281"},{"25.555 km2","75 641"},{"72.289 km2","75,191"},{"136.358 km2","75,550"},/*2*/{"49.36 km2","252,040"},{"40.41 km2","153,668"},{"102.27 km2","52,532"},{"34.2 km2 ","51,182"},{"32.3 km2","52,648"},
    ...
    public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
        ...
        if (spinner.getId()==R.id.spin1) {
            if(position==1) {
                arrayS = CitiesAfrica;
                arrayI= IaboutCitiesAfrica;
            }
            else if (position==2){
                arrayS=CitiesAmerica;
                arrayI= IaboutCitiesAmerica;
            }
            else if (position==3) {
                arrayS=CitiesAsia;
                arrayI= IaboutCitiesAsia;
            }
            else if(position==4) {
                arrayS=CitiesEurope;
                arrayI= IaboutCitiesEurope;
            }
            if (position == 0) {
