...
public class MainActivity extends AppCompatActivity implements AdapterView.OnItemSelectedListener, AdapterView.OnItemClickListener {
    ...
    String [][] CitiesAsia = {{"Anqing", "Beijing", "Fuyang", "Huainan", "Longyan"}, {"Amravati", "Bhiwandi", "Firozabad", "Guntur", "Noida"},{"Beersheba", "Tel Aviv", "Jerusalem", "Hifa", "Natanya"}, {"Anjo", "Chita", "Gamagōri", "Ōbu", "Yatomi"}, {"Berezniki", "Dimitrovgrad", "Kaspiysk", "Nazran","Obninsk"}, {"Ankara", "Batman", "Darıca", "İzmit", "KırıkkaleSiverek"}, {"Aden", "Hajjah", "Ibb", "Khamir", "Socotra"}};
    ...
    String [][] IaboutCitiesAs = {/*1*/{"13,590 km2","5,311,379"},{"16,410.5 km2","21,542,000"},{"9,775 km2","7,599,913"},{"5,533 km2","2,333,896"},{"19,069 km2","2,559,545"},/*2*/{"183 km2 ","647,057"},{"195 km2","709,665"},{"155 km2","603,797"},{"168.4 km2","743,354"},{"203 km2","637,272"},
            /*3*/{"9.50 km2","10,330"},{"51.8km2","460,613"},{"125.2km2","936,425"},{"63.7km2","285,316"},{" 29.0km2","221,353"},/*4*/{"86.05 km2","188,693"},{"45.90 km2","83,891"},{"56.92 km2","80,063"},{"33.66 km2","92,179"},{"49.00 km2","44,589"},
    ...
    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
        ...
        x=x+position;
        tv1.setText(IaboutCitiesAf[x][0]+" area");
        tv2.setText(IaboutCitiesAf[x][1]+" populotion");
    }
}